...
const Hero = () => {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative w-full h-[100dvh] flex items-end justify-start bg-dark overflow-hidden"
    >
      {/* Background Image */}
      <div 
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 w-full h-full bg-gradient-to-t from-primary via-primary/50 to-transparent"></div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-24 md:pb-32 flex flex-col items-start">
        <h1 className="flex flex-col text-background">
          ...
          <span className="hero-elem font-drama italic font-semibold text-6xl md:text-8xl lg:text-[9rem] leading-[0.9] tracking-tighter">
            Precision Audit.
          </span>
        </h1>
